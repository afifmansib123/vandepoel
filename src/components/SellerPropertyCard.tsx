        ...
        <div className="relative h-60 w-full">
          ...
          <div className="absolute top-3 right-3 flex flex-col gap-2 items-end">
            {property.propertyStatus && (
              <div className={`text-white text-xs font-semibold uppercase px-3 py-1.5 rounded-md shadow-lg ${
            ...
            {property.isTokenized && (
              <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs font-bold uppercase px-3 py-1.5 rounded-md shadow-lg flex items-center gap-1">
