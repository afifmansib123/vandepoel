...
import {
  ...
  Droplet, Zap, Settings, Bug, Hammer
} from "lucide-react";
                    ...
                    {step === 1 && (
                        <div className="p-6">
                            <div className="text-center mb-6">
                                <h3 className="text-xl font-semibold text-gray-800 mb-2">What type of issue needs attention?</h3>
                                <p className="text-gray-600">Select the category that best describes the maintenance needed</p>
                            </div>
                    ...
                    {step === 2 && selectedCategory && (
                        <div className="p-6">
                            ...
                            <div className="text-center mb-6">
                                ...
                                <p className="text-gray-600">What specific problem needs to be addressed?</p>
                            </div>
...
{property && property.photoUrls && property.photoUrls.length > 0 ? (
  ...
  <div className="bg-white border border-primary-200 rounded-2xl p-7 h-fit min-w-[300px] space-y-4">
    <Button
      ...
      onClick={() => {}} // Your existing Edit Property logic
    >
      Edit Property
    </Button>
...
{property && authUser && (
  <CreateMaintenanceRequestModal
    ...
    property={{
      _id: property._id,
      name: property.name,
      // The landlord is the manager in this context
      managedBy: authUser.cognitoInfo?.userId || "", 
    }}
    // The landlord is also the one creating the request
