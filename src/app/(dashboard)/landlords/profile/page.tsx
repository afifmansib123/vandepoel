  ...
  useEffect(() => {
    if (landlordData) {
      setFormData({
        ...
        postalCode: landlordData.postalCode || "",
        cityName: landlordData.cityName || "",
        country: landlordData.country || "",
        vatId: landlordData.vatId || "",
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          ...
          <p className="text-gray-700">
            Could not find landlord information. Please try again.
          </p>
        </div>
      </div>
    );
          ...
          <div className="bg-white rounded-lg shadow-md p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-gray-900">
                    {landlordData.website ? (
                      <a
                        href={landlordData.website}
                        target="_blank"
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-gray-900">
                  {landlordData.businessAddress || "Not provided"}
                </p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-gray-900">
                    {landlordData.cityName || "Not provided"}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-gray-900">
                    {landlordData.postalCode || "Not provided"}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-gray-900">
                    {landlordData.country || "Not provided"}
                  </p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-gray-900">
                  {landlordData.vatId || "Not provided"}
                </p>
              )}
            </div>
