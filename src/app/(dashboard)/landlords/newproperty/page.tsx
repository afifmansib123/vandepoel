        ...
        <form onSubmit={handleSubmit(onSubmit, onInvalid)} className="space-y-8">
          ...
          <div className={sectionCardClassName}>
            ...
            <div className="space-y-6">
              ...
              <FormField control={control} name="agreementDocument" render={({ field: { onChange, ...fieldProps } }) => (
                <FormItem>
                  <FormLabel>Sales Agreement Template / Info (Optional)</FormLabel>
                  <FormControl>
                    <Input type="file" accept=".pdf,.doc,.docx,.txt" onChange={(e) => onChange(e.target.files)} {...fieldProps} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}/>
          ...
          <div className={sectionCardClassName}>
            ...
            <div className="space-y-6">
              <FormField control={control} name="amenities" render={({ field }) => (
                <FormItem>
              ...
              <FormField control={control} name="highlights" render={({ field }) => (
                <FormItem>
